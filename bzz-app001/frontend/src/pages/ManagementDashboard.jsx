...
export default function ManagementDashboard() {
  ...
  const load = () => {
    (async () => {
      ...
      const [wq5508Progress, wq1075Progress , feedbackProgress, wq5508WorkProgress, wq1075WorkProgress, adminlist] = await Promise.all([request.list("incomingwqprogress"), request.list("incomingwqprogress"), request.list("feedback"), request.list("incomingwqWork"), request.list("incomingwqWork"), request.list("admin")]);
     ...
     let liAdmin  =  admin.filter(list => list.ManagementAccess == 1 && list.Nickname.toLowerCase() != "admin" && list.Nickname.toLowerCase() != "Jason")
     ...
     wq5508 = (wq5508.sort((a,b) => {
      return a.First.localeCompare(b.First)
       ...
       for(let i=0; i<wq5508.length; i++) {
         sumwq5508 += wq5508[i] ? +wq5508[i].ChargesProcessed : 0;
