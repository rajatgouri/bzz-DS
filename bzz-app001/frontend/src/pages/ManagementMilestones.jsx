...
export default function ManagementMilestones() {
  ...
  const onSaveReminder = async () => {
    ...
    const resposne = await request.update('billingreminder', ID, {Milestones: value});
    notification.success({message: "Milestones Updated Successfully!",duration:3})
  ...
  useEffect(() => {
    (async () => {
      ...
      setValue(resposne.result[0].Milestones ?  resposne.result[0].Milestones : "Hello!")        
