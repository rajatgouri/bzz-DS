...
import { Form, Input, Button,  Layout, Row, Col, Divider, notification } from "antd";
...
const ResetChangePassword = () => {
  ...
  const onFinish = async(value) => {
    ...
    await request.create('change-password', {password: value.password, EMPID: EMPID})
  ...
  useEffect(() => {
    if(id) {
      var decoded = jwt_decode(( id.replace(/"/g, '')))
      setEMPID(decoded.id)
    }
  },[id])
