...
export default function MilestonesAndRoadmap() {
  ...
  const onSaveReminder = async () => {
    ...
    const resposne = await request.update('billingreminder', ID, {MilestonesAndRoadmap: value});
    notification.success({message: "Milestones and Roadmap Updated Successfully!",duration:3})
  ...
  useEffect(() => {
    (async () => {
      ...
      setValue(resposne.result[0].MilestonesAndRoadmap ?  resposne.result[0].MilestonesAndRoadmap : "Hello!")
    })()
  }, [])
